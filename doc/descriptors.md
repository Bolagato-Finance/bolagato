# Support for Output Descriptors in Bolagato Core

Since Bolagato Core v0.17, there is support for Output Descriptors. This is a
...
on Bolagato's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Bolagato Core wallets, a convenience function `combo` is
