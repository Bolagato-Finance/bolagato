...
const char * const BITCOIN_CONF_FILENAME = "bolagato.conf";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Bolagato";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Bolagato";
#else
    // Unix
    return pathRet / ".bolagato";
#endif
#endif
}
