...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " bolagato-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  bolagato-tx [options] <hex-tx> [commands]  Update hex-encoded bolagato transaction\n" +
            "or:     bolagato-tx [options] -create [commands]   Create hex-encoded bolagato transaction\n" +
            "\n";
