...
"""Verify that starting bolagato with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start bolagato with -h for help text")
        ...
        self.log.info("Start bolagato with -version for version information")
        ...
        self.log.info("Start bolagatod with -fakearg to make sure it does not start")
