...
{
    const char* pszTimestamp = "Anarco boquetismo de livre babao";
...
public:
    CMainParams() {
        ...
        consensus.BIP34Hash = uint256S("0x3153e6da925d68c2c2a48611ca8e864aa42660505aa74a26f55b4218dfcfcea9");
        ...
        consensus.defaultAssumeValid = uint256S("0x3153e6da925d68c2c2a48611ca8e864aa42660505aa74a26f55b4218dfcfcea9"); //1683528
        ...
        genesis = CreateGenesisBlock(1641523017, 1000414241, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x3153e6da925d68c2c2a48611ca8e864aa42660505aa74a26f55b4218dfcfcea9"));
        assert(genesis.hashMerkleRoot == uint256S("0x483f1119fd83fdd32f81b44c32e40dfed40a7dfb02199c5d6651470a080ca0ed"));
        ...
        vSeeds.emplace_back("bolagato.girino.org");

        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,25);
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,28);
        base58Prefixes[SCRIPT_ADDRESS2] = std::vector<unsigned char>(1,30);
        ...
        checkpointData = {
            {
                {0, uint256S("0x3153e6da925d68c2c2a48611ca8e864aa42660505aa74a26f55b4218dfcfcea9")},
            }
        };
...
public:
	...
	nDefaultPort = 35199;
        ...
        vSeeds.emplace_back("testnet-bolagato.girino.org");
